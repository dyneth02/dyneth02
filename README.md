...
<div style="display:flex; justify-content:center; aligh-items:center; postion: relative">
    ...
    <div style="inline-block">
        <h1 style="text-align:center; margin-bottom:1.15em; postion: relative; font-family:Syne;" align="center"> Languages, Frameworks, and Tools&nbsp<img src="https://github.com/dyneth02/dyneth02/blob/main/resources/behold.gif" height="100"></h1>
        <table align="center">
            <tr>
